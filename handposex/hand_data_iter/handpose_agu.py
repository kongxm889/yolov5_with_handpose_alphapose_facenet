...
def plot_box(bbox, img, color=None, label=None, line_thickness=None):
    ...
    if label:
        ...
        t_size = cv2.getTextSize(
            label, 0, fontScale=tl / 4, thickness=tf)[0]  # label size
        ...
        if ".jpg" in f_:
            ...
            if len(hand_dict_) > 0:
                for msg in hand_dict_:
                    ...
                    if vis:
                        plot_box((x_min, y_min, x_max, y_max), img_, color=(
                            255, 100, 100), label="hand", line_thickness=2)
                    #
                    if True:
                        ...
                        hand_rot, pts_tor_landmarks, M_I = hand_alignment_aug_fun(img_ago, pt_left, pt_right,
                                                                                  ...
                                                                                  angle=angle_random, desiredLeftEye=(
                                                                                      scale_x, 0.5),
                    ...
                    hand_idx += 1
                    cv2.imwrite(
                        "../test_datasets/{}.jpg".format(hand_idx), hand_rot)
                    #
                    pts_hand = {}
                    pts_hand_global_rot = {}
                    for ptk in range(21):
                    ...
                    if vis:
                        ...
                        plot_box((x1, y1, x2, y2), img_, color=(
                            RGB), label="hand", line_thickness=3)
