...
from models_canary.scaledv4 import Darknet as Model
...
from utils.loss_v4 import ComputeLoss, compute_loss
...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    nl = len(model.yolo_layers)  # number of detection layers (used for scaling hyp['obj'])
