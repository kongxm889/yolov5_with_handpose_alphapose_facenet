...
class YoloV6(nn.Module):
    ...
    def __init__(self, cfg, ch=3):
        ...
        self.backbone = mobilenetv3_large(fpn_levels=[5, 9, 14])
        
        bc = 40
        # PANet
        self.conv5 = ConvBase(4*bc//cd, 2*bc//cd)
        self.up1 = nn.Upsample(scale_factor=2)
        self.csp5 = SimBottleneckCSP(4*bc//cd, 2*bc//cd, n=3//wd, shortcut=False)

        self.conv6 = ConvBase(2*bc//cd, bc//cd)
        self.up2 = nn.Upsample(scale_factor=2)
        self.csp6 = SimBottleneckCSP(2*bc//cd, bc//cd, n=3//wd, shortcut=False)

        self.conv7 = ConvBase(bc//cd, bc//cd, 3, 2)
        self.csp7 = SimBottleneckCSP(2*bc//cd, 2*bc//cd, n=3//wd, shortcut=False)

        self.conv8 = ConvBase(2*bc//cd, 2*bc//cd, 3, 2)
        self.csp8 = SimBottleneckCSP(2*bc//cd, 4*bc//cd, n=3//wd, shortcut=False)
