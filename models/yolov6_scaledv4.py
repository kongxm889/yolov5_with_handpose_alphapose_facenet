...
We are going re-implement ScaledYolov4 inside yolov4 without cfg file.

All CSP related part will implemented by hand without fancy messy cfg files.

[UNDER CONSTRUCTION] Please don't use it for now
